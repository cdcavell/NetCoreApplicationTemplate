...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectTemplate.Infrastructure.Data.Entities.ApplicationAuditReconciliationFinding", b =>
                {
                    b.Property<Guid>("Id").HasColumnType("TEXT");
                    b.Property<string>("ConcurrencyStamp").IsConcurrencyToken().IsRequired().HasMaxLength(64).HasColumnType("TEXT");
                    b.Property<string>("Destination").HasMaxLength(128).HasColumnType("TEXT");
                    b.Property<string>("FindingKey").IsRequired().HasMaxLength(128).HasColumnType("TEXT");
                    b.Property<DateTime>("FirstObservedUtc").HasPrecision(3).HasColumnType("TEXT");
                    b.Property<string>("Guidance").IsRequired().HasMaxLength(512).HasColumnType("TEXT");
                    b.Property<DateTime>("LastObservedUtc").HasPrecision(3).HasColumnType("TEXT");
                    b.Property<string>("MutationBatchId").IsRequired().HasMaxLength(64).HasColumnType("TEXT");
                    b.Property<string>("ReasonCode").IsRequired().HasMaxLength(64).HasColumnType("TEXT");
                    b.Property<string>("RemediationStatus").IsRequired().HasMaxLength(32).HasColumnType("TEXT");
                    b.Property<DateTime?>("ResolvedUtc").HasPrecision(3).HasColumnType("TEXT");
                    b.Property<string>("SchemaVersion").IsRequired().HasMaxLength(32).HasColumnType("TEXT");
                    b.Property<string>("Severity").IsRequired().HasMaxLength(32).HasColumnType("TEXT");
                    b.HasKey("Id");
                    b.HasIndex("FindingKey").IsUnique();
                    b.HasIndex("MutationBatchId", "ReasonCode");
                    b.HasIndex("RemediationStatus", "Severity");
                    b.ToTable("ApplicationAuditReconciliationFindings", (string)null);
                });

            modelBuilder.Entity("ProjectTemplate.Infrastructure.Data.Entities.ApplicationAuditReconciliationRemediation", b =>
                {
                    b.Property<Guid>("Id").HasColumnType("TEXT");
                    b.Property<string>("ActionCode").IsRequired().HasMaxLength(64).HasColumnType("TEXT");
                    b.Property<string>("ActorId").IsRequired().HasMaxLength(256).HasColumnType("TEXT");
                    b.Property<string>("ConcurrencyStamp").IsConcurrencyToken().IsRequired().HasMaxLength(64).HasColumnType("TEXT");
                    b.Property<string>("EvidenceReference").HasMaxLength(256).HasColumnType("TEXT");
                    b.Property<Guid>("FindingId").HasColumnType("TEXT");
                    b.Property<string>("MutationBatchId").IsRequired().HasMaxLength(64).HasColumnType("TEXT");
                    b.Property<DateTime>("RecordedUtc").HasPrecision(3).HasColumnType("TEXT");
                    b.HasKey("Id");
                    b.HasIndex("FindingId");
                    b.HasIndex("MutationBatchId");
                    b.ToTable("ApplicationAuditReconciliationRemediations", (string)null);
                });

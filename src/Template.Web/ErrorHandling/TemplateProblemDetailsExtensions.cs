...
namespace Template.Web.ErrorHandling;
...
internal static class TemplateProblemDetailsExtensions
{
    /// <summary>
    ...
    public static IServiceCollection AddTemplateProblemDetails(
        ...
        IWebHostEnvironment webHostEnvironment)
    {
        ...
        services.AddExceptionHandler<TemplateProblemDetailsExceptionHandler>();
    ...
    public static WebApplication UseTemplateProblemDetails(this WebApplication app)
    {

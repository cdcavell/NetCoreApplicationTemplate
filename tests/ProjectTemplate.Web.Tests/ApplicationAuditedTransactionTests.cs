...
public sealed class ApplicationAuditedTransactionTests
{
    ...
    public async Task ExecuteAsync_GeneratedKeyAuditCompletion_CommitsCompletedKey()
    {
        ...
        AuditRecord auditRecord = await context.AuditRecords.SingleAsync(
    ...
    private static AuditRecord CreateCompletionRecord(
    ...
    private sealed class GeneratedKeyModelCustomizer(
        ...
        : ModelCustomizer(dependencies)
    {
        public override void Customize(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            EntityTypeBuilder<ExternalLoginAccount> builder = modelBuilder
                .Entity<ExternalLoginAccount>();
            _ = builder.Property<int>("GeneratedId")
                .ValueGeneratedOnAdd();
